...
<div class='admin-container'>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent2">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url();?>">Danh mục<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url();?>">Sản phẩm<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url();?>">Thông báo<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url();?>">Đơn hàng<span class="sr-only">(current)</span></a>
        </li>
        </ul>
    </div>
    </nav>
